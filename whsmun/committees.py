...
COMMITTEES: Final[tuple[Committee, ...]] = (
    ...
    Committee("Iranian Revolution", "SINGLE", 1, "Specialized Agency 2", "Iranian Revolution"),
    Committee("UNCSW",              "SINGLE", 1, "Specialized Agency 3", "UNCSW"),
    Committee("Madagascar",         "SINGLE", 1, "Specialized Agency 4", "Madagascar"),
