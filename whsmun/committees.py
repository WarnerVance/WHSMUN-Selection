...
COMMITTEES: Final[tuple[Committee, ...]] = (
    ...
    Committee("EU",                 "SINGLE", 1, "EU",                 "EU"),
    Committee("AU",                 "SINGLE", 1, "AU",                 "AU"),
    Committee("ASEAN",              "SINGLE", 1, "ASEAN",              "ASEAN"),
    Committee("ICJ",                "SINGLE", 1, "ICJ",                "ICJ"),
    Committee("Iranian Revolution", "SINGLE", 1, "Iranian Revolution", "Iranian Revolution"),
    Committee("UNCSW",              "SINGLE", 1, "UNCSW",              "UNCSW"),
    Committee("Madagascar",         "SINGLE", 1, "Madagascar",         "Madagascar"),
